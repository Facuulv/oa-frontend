...
export default function AdminPanelLayout({ children }) {
  ...
  if (showGate) {
    return (
      <AppViewport variant="admin" innerClassName="flex flex-col items-center justify-center gap-3 overflow-hidden bg-[#ececec] px-6 text-center ring-1 ring-black/5">
